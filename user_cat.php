...
<div class="row">
            ...
            <div class="col-lg-8">
              <?php
			  $q11=mysqli_query($connect,"select * from category");
			  ...
			  <?php
				...
				{
			  	$q1=mysqli_query($connect,"select * from category where id=$arr1[$i]");
			  	$q1=mysqli_query($connect,"select * from category where id=$arr1[$i]");
			  ...
			  <tr>
			  <td>
			  <h3 align="center" class="bg-primary"><?php echo $r1['category']; ?></h3>
			   </td>
			   </tr>
			   <tr>
			   <td>
			   <a href="user.php?shop=<?php echo $r1['shop']; ?>&catid=<?php echo $r1['id']; ?>"><img src="upload/<?php echo $r1['filename']; ?>" width="300" height="300" /></a>
			   </td>
			   </tr>
			   </table>
